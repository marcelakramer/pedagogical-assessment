...
// Define the path to the _progress-spinner-theme.scss file within node_modules
const filePath = path.resolve(__dirname, 'node_modules', '@angular', 'material', 'progress-spinner', '_progress-spinner-theme.scss');

// Define the new content to replace the existing one
const newContent = `@use '../core/style/sass-utils';
